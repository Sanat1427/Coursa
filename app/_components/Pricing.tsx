            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col items-center">
                <div className="text-center mb-12 relative">
                    <h2 className="font-display text-4xl font-bold text-slate-900 mb-4">
                        Demo <span className="text-sketch-orange italic scribble-underline">Licenses</span>
                    </h2>
                    <p className="font-sans text-xl text-slate-600 max-w-2xl mx-auto">
                        Coursa is a sandbox learning experience. Pick a test license tier to explore credit scaling.
                    </p>
                </div>
